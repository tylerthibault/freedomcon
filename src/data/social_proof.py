social_proof = [
    ...
    },
    {
        ...
        "quote": "This conference flies in the face of a culture that says men aren’t important, aren’t needed, and that masculinity is toxic. I left last year’s conference with a brotherhood of men ready to step into the breach with me, ready to fight for biblical manhood for the good of my marriage, my family, my workplace, and my community. You will leave fired up for Jesus and ready to live into His plan for your life!",
        "alt": "Patrick Valeri testimonial photo",
    },
    {
        "name": "Michael Vasquez",
        "title": "Performance Coach & Consultant",
        "quote": "Attending these conferences with my son has sharpened my awareness of what it means to lead my home spiritually. Being around real, godly men who genuinely love and follow Jesus has given me a model worth imitating and a blueprint to hand to my son. When men follow Christ, the fruit speaks for itself — strong homes, strong families, and a legacy built on the greatest instruction manual ever written.",
        "alt": "Michael Vasquez testimonial photo",
    },
    {
        "name": "Eric Chase",
