speakers = [
	...
	{
		'name': 'John Lovell',
		'image': 'img/speakers/JohnL (3).png',
		'alt': 'John Lovell',
	...
	{
		'name': 'Josh Howerton',
		'image': 'img/speakers/JoshH (2).png',
		'alt': 'Josh Howerton',
...

	{
		...
		'alt': 'Nate Schatzline',
		'titles': ['Preaching Pastor, Mercy Culture Church', 'Texas House of Representatives', 'Founder, For Liberty & Justice']
	},
	{
		'name': 'Mark Driscoll',
		'image': 'img/speakers/mark 4.png',
		'alt': 'Mark Driscoll',
...

	{
		...
		'alt': 'Tim Barton',
		'titles': ['President of WallBuilders', 'Host, The American Story Podcast']
	},
	{
		'name': 'Dave Barton',
