speakers = [
...
},
	{
		...
		'bio': """
			Josh Howerton is the senior pastor of Lakepointe Church, a multi-site, multilingual movement with multiple campuses across the Dallas area committed to helping people know Christ, live free, and change the world. Before taking the helm at Lakepointe, Josh studied Biblical Studies at Union University, continued his theological training at Southern Seminary, and spent a decade pastoring The Bridge Church in Nashville. He hosts the “Live Free with Josh Howerton” podcast, where he speaks straight to men about sin, freedom, marriage, and mission in a style that’s more locker-room talk than ivory-tower lecture. Under his leadership, Lakepointe has become a place where men are challenged to throw off religious apathy, embrace authentic repentance, and step into spiritual leadership at home, in church, and in culture.
		 """,
		'shrink': 0.85,
        'image_x': 20,
	        "orgs": [{"icon": "church", "name": "Lakepointe Church", "subtitle": "Dallas multi-site"}, {"icon": "podcast", "name": "Live Free Podcast", "subtitle": "Honest talk for men"}],
},
	{
		'name': 'Graham Allen',
		...
		'bio': """
		 ...
		 """,
	        "orgs": [{"icon": "mic", "name": "The Graham Allen Show", "subtitle": "Conservative commentary"}, {"icon": "star", "name": "U.S. Army", "subtitle": "12-year combat veteran"}],
},
	{
		'name': 'Chad Robichaux',
		...
		'bio': """
		 ...
		 """,
		'image_y': -40,
	        "orgs": [{"icon": "shield", "name": "Mighty Oaks Foundation", "subtitle": "Healing combat trauma"}, {"icon": "star", "name": "Force Recon Marine", "subtitle": "JSOC Operator"}],
},
	{
...
},
	{
		...
		'bio': """
			Mark Driscoll is a battle-tested pastor, church planter, and author who has spent three decades calling men to spiritual grit and courage. He first made his mark by founding Mars Hill Church in Seattle, which grew from a living-room Bible study into a multi-campus movement reaching tens of thousands in one of the most hostile environments to the gospel in America. Mark helped launch the Acts 29 church-planting network and other ministries that have trained pastors and planted churches around the world, and today he serves as the founding pastor of Trinity Church in Scottsdale, Arizona, preaching a direct, no-apologies message of repentance, masculinity, and allegiance to Christ. A prolific author and outspoken cultural critic, he’s known for confronting passive, consumer Christianity and calling men to lead their families, serve their churches, and stand firm in a collapsing culture.
		 """,
	        "orgs": [{"icon": "church", "name": "Trinity Church", "subtitle": "Scottsdale, AZ"}, {"icon": "book", "name": "Real Faith", "subtitle": "Biblical boldness"}],
},
	{
		'name': 'Tim Barton',
...
},
	{
		...
		'bio': """
			Adam James is the lead pastor of Grace City Church, where he is raising up men and families to follow Jesus with grit, joy, and conviction in everyday life. (Public information on Adam is more limited than some of the national figures here, so this bio focuses on his pastoral role and the kind of leadership he is known for on-the-ground in his church and city.) Drawing on years of local-church ministry, Adam preaches a clear, Christ-centered gospel and calls men out of passivity into sacrificial service at home, in church, and in the public square. In a cultural moment obsessed with image and comfort, he is steadily building a biblical, masculine culture that prizes repentance, responsibility, and brotherhood over hype.

			If you send me a link to his church’s bio page, I can tighten this further to match his exact story and accomplishments.
		 """,
		'shrink': 0.9,
	        "orgs": [{"icon": "church", "name": "Grace City Church", "subtitle": "Local pastoral leadership"}],
},
	{
		'name': 'Ryan Visconti',
